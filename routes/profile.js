...
router.get('/', wrap(async (req, res, next) => {
    res.render('profile', {
        title: 'TEST CODE',
        response: {
            bets:[ //TODO create matching bet test data to the games
                {"_id":"5dd2f9632a5e4928183c4f84","userId":"5dd1c029f05a9b161cabbef6","roundIndex":0,"gameBets":[{"id":"5dbb5ba824a8c8398c3a0f8b","teamATries":4,"teamBTries":1,"winTeam":"Japan","points":7}],"goldenTry":12,"points":7,"CsTest":"true"},
                {"_id":"5dd2fc542a5e4928183c4f85","userId":"5dd1c029f05a9b161cabbef6","roundIndex":1,"gameBets":[{"id":"5dbb5ba824a8c8398c3a0f8b","teamATries":3,"teamBTries":6,"winTeam":"Englang","points":9},{"id":"5jhjhj5jhj23gj2kj5jk34b","teamAtries":7,"teamBtries":1,"winTeam":"Wales","points":2}],"goldenTry":2,"points":11,"CsTest":"true"}
            ],
            rounds:[
        ...
        user: {"_id":"5dd1c029f05a9b161cabbef6","email":"bob@hello.com","password":"$2b$10$KjIMxK98etqsaQ6BOCb/DOHSnTESkffKUlIOfMJahZWOf/N//Vx9a","firstName":"bob","surname":"Fuck","isAdmin":false,"isActive":true}
    });
}));
